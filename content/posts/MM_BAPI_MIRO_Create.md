...
DATA:LT_GLACC           LIKE TABLE OF BAPI_INCINV_CREATE_GL_ACCOUNT.
DATA:LS_GLACC           LIKE BAPI_INCINV_CREATE_GL_ACCOUNT.
...
" Header "
CLEAR: LS_HEADERDATA.
LS_HEADERDATA-INVOICE_IND  = 'X'. "贷项凭证"
